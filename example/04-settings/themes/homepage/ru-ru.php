...
<body>
	...
	<h2>04-settings</h2>
	<h3>Для сохранения настроек &amp; Профиль</h3>
	...
	<ol>
		<li>Текущее значение глобального языка: <?php echo lp\go::_getCurrentlp(); ?></li>
		<li>Операция файла: <?php echo lp\go::_getCurrentsetFileType(); ?></li>
		<li>Сохраните путь файла конфигурации: <?php echo lp\go::_getCurrentFileType(); ?></li>
	...
	<ol>
		<li>Прочитайте краткое руководство -> <a href="https://lang-php.com/go/lp-docs-four">https://lang-php.com/go/lp-docs-four</a></li>
		<li>воли 'example/04-settings' Загрузите все файлы в каталоге в каталог вашего сайта;</li>
		<li>Изменение <?php echo lp\go::_getCurrentFileType(); ?> Разрешения для файлов 777；</li>
		<dt>chmod 777 &lt; folder &gt; /<?php echo lp\go::_getCurrentFileType(); ?></dt>
		<li>Необязательные XML/cfg типа (XML по умолчанию), Редактирование libraries/classes/go.php Файл и изменить $setFileType Переменная;</li>
